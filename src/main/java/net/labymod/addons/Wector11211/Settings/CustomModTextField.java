...
public class CustomModTextField extends Gui {
    ...
    public CustomModTextField(int componentId, FontRenderer fontrenderer, int x, int y, int par5Width, int par6Height) {
        this.id = componentId;
        ...
        if (this.getVisible()) {
            ...
            if (this.getEnableBackgroundDrawing()) {
                if (this.blackBox) {
                    ...
                    LabyMod.getInstance().getDrawUtils().drawRectBorder((double)(this.xPosition - 1), (double)(this.yPosition - 1), (double)(this.xPosition + this.width + 1), (double)(this.yPosition + this.height + 1), ModColor.toRGB(220, 220, 225, 62), 1.0);
                    ...
                    drawRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, ModColor.toRGB(70, 60, 53, 122));
                    drawRect(this.xPosition + 1, this.yPosition + 1, this.xPosition + this.width - 1, this.yPosition + this.height - 1, ModColor.toRGB(0, 0, 3, 180));
                }
            }
    ...
    public void drawColorBar(int mouseX, int mouseY) {
        if (this.colorBarEnabled) {
            ...
            for(int var8 = 0; var8 < var7; ++var8) {
                ...
                drawRect(pX - ll / 2, pY - 1, pX + ll / 2, pY + 9, !hovered ? ModColor.toRGB(120, 120, 120, 120) : Integer.MAX_VALUE);
                LabyMod.getInstance().getDrawUtils().drawCenteredString(color.toString() + color.getColorChar(), (double)pX, (double)pY);
                pX += ll;
            }
        }
